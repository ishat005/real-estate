...
import { FaSliders, FaArrowRotateLeft } from "react-icons/fa6";
...
const Properties = () => {
  ...
  const filteredProperties = properties.filter((property) => {
    ...
    if (budget === "Under 100K") {
      matchesBudget = property.price < 100000;
    }

    if (budget === "100K - 500K") {
      matchesBudget = property.price >= 100000 && property.price <= 500000;
    }

    if (budget === "500K - 1M") {
      matchesBudget = property.price > 500000 && property.price <= 1000000;
    }

    if (budget === "Above 1M") {
      matchesBudget = property.price > 1000000;
    }
    ...
    if (bathrooms !== "Any") {
      matchesBathrooms = property.bathrooms >= Number(bathrooms);
    }
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <section
        id="properties"
        className="mx-auto max-w-8xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8"
      >
        {/* Header */}
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          {/* Sort */}
          <select
            className="h-12 w-full rounded-xl border border-slate-200 bg-white px-4 text-sm text-slate-700 outline-none transition-all duration-200 focus:border-slate-900 focus:ring-4 focus:ring-slate-900/5 sm:w-56"
            value={sortBy}
        ...
        {loading ? (
          <div className="grid gap-8 lg:grid-cols-[280px_minmax(0,1fr)]">
            <div className="h-fit rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-6 h-6 w-24 animate-pulse rounded bg-slate-200" />
          ...
          <div className="grid gap-8 lg:grid-cols-[280px_minmax(0,1fr)]">
            ...
            <aside className="h-fit rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
              <div className="mb-6 flex items-center gap-2">
                <FaSliders className="text-sm text-slate-400" />
              ...
              <div className="mb-5">
                ...
                <select
                  ...
                  className="h-12 w-full appearance-none rounded-xl border border-slate-200 bg-slate-50 px-4 text-sm text-slate-700 outline-none transition-all duration-200 focus:border-slate-900 focus:bg-white focus:ring-4 focus:ring-slate-900/5"
                >
              ...
              <div className="mb-5">
                ...
                >
                  ...
                  <option value="Under 100K">Under CAD 100K</option>

                  <option value="100K - 500K">CAD 100K - 500K</option>

                  <option value="500K - 1M">CAD 500K - 1M</option>

                  <option value="Above 1M">Above CAD 1M</option>
                </select>
              </div>
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 py-3 text-sm font-semibold text-slate-700 transition-all duration-200 hover:border-slate-300 hover:bg-slate-50"
              >
