      ...
      <div className="mx-auto max-w-8xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 border-t border-white/20 pt-8">
          <div className="logo-row grid gap-8 text-center sm:grid-cols-2 lg:grid-cols-4">
            <img src="/src/assets/images/equinix.webp" alt="Equinix" className="mx-auto h-12 w-auto object-contain opacity-90 transition duration-300 hover:-translate-y-1 hover:scale-105" />
            <img src="/src/assets/images/digitalRealty.webp" alt="Digital Realty" className="mx-auto h-12 w-auto object-contain opacity-90 transition duration-300 hover:-translate-y-1 hover:scale-105" />
            <img src="/src/assets/images/equinix.webp" alt="Equinix" className="mx-auto h-12 w-auto object-contain opacity-90 transition duration-300 hover:-translate-y-1 hover:scale-105" />
            <img src="/src/assets/images/digitalRealty.webp" alt="Digital Realty" className="mx-auto h-12 w-auto object-contain opacity-90 transition duration-300 hover:-translate-y-1 hover:scale-105" />
          </div>
        </div>
