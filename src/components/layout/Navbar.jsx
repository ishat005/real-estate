    ...
    <nav className="bg-[#dfeaf5] shadow-sm">
      <div className="mx-auto grid w-full max-w-8xl grid-cols-1 items-center gap-3 px-6 py-4 md:grid-cols-[1fr_auto_1fr]">
        ...
        <div className="flex items-center justify-center gap-2 sm:gap-3 md:gap-7">
          <NavLink to="/" className="text-[14px] font-medium text-slate-700 hover:text-slate-950 sm:text-sm">
            Home
          </NavLink>
          <NavLink to="/about" className="text-[14px] font-medium text-slate-700 hover:text-slate-950 sm:text-sm">
            About Us
          </NavLink>
          <NavLink to="/properties" className="text-[14px] font-medium text-slate-700 hover:text-slate-950 sm:text-sm">
            Properties
          </NavLink>
          <NavLink to="/contact" className="text-[14px] font-medium text-slate-700 hover:text-slate-950 sm:text-sm">
            Contact Us
          </NavLink>
        </div>
